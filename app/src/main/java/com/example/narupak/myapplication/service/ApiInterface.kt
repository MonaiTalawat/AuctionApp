...
interface ApiInterface {
    ...
    @GET("queryHistoryAuctionByLicenseCarId")
    abstract fun queryHistoryAuctionByLicenseCarId(@Query("licenseCarId") licenseCarId: Long) : Call<List<DetailHistoryAuction>>
